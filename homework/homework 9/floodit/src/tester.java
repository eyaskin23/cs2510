...
class FloodItWorld extends World {
  ...
  public WorldScene makeScene() {
    ...
    finalScene.placeImageXY(
    	new TextImage("Moves:", 25, FontStyle.BOLD, 
    		Color.black), 580, 200);
    finalScene.placeImageXY(
        new TextImage(Integer.toString(clicks) + "     ", 25, FontStyle.BOLD_ITALIC, 
            Color.black), 650, 200);
    finalScene.placeImageXY(
        new TextImage(" / " + Integer.toString(required), 25, FontStyle.BOLD_ITALIC,
            Color.black), 700, 200);
    finalScene.placeImageXY(new TextImage("Welcome to Flood-IT! CS 2510", 25, 
        FontStyle.BOLD_ITALIC, Color.BLACK), 240, 550);
    WorldImage outline = 
    ...
    finalScene.placeImageXY(new TextImage("Time: " + time / 10 + "s", 25,
        FontStyle.BOLD_ITALIC, Color.black), 650, 250);
    if (clicks >= required
        && (!allFlooded())) {
