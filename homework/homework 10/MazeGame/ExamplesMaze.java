...
class ExamplesMaze {
  ...
  boolean testDrawCell(Tester t) {
    ...
    WorldImage wallsG = new RectangleImage(10, 10, OutlineMode.OUTLINE, Color.YELLOW);
  ...
  boolean testWasChecked(Tester t) {
    this.initFields();
    WorldImage walls = new RectangleImage(10, 10, OutlineMode.OUTLINE, Color.GRAY);
    WorldImage wallsVisited = new RectangleImage(10, 10, OutlineMode.OUTLINE, Color.CYAN);
    WorldImage wallsCorrect = new RectangleImage(10, 10, OutlineMode.OUTLINE, Color.YELLOW);
    WorldImage newWall;
    newWall = new LineImage(new Posn(10, 0), Color.DARK_GRAY);
  ...
  boolean testConstructMaze(Tester t) {
    ...
    boolean checkNumConnections1 = t.checkExpect(maze1.checkNumConnectedEdges(), 5999)
    ...
    boolean checkNumConnections2 = t.checkExpect(maze1.checkNumConnectedEdges(), 5999)
        && t.checkExpect(maze2.checkNumConnectedEdges(), 10 * 10 - 1)
        && t.checkExpect(maze3.checkNumConnectedEdges(), 4 * 50 - 1)
        && t.checkExpect(maze4.checkNumConnectedEdges(), 2);
  ...
  boolean testCheckValidMinSpanningTree(Tester t) {
    this.initFields();
    boolean checkFirst = t.checkExpect(maze1.checkValidMinSpanningTree(), true)
    ...
    boolean checkSecond = t.checkExpect(maze1.checkValidMinSpanningTree(), true)
        && t.checkExpect(maze4.checkValidMinSpanningTree(), true);
