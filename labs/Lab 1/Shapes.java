...
interface IShape {
//compute the area of this IShape
double area();
//compute the distance to 0 of this IShape
double distToOrigin();
//is this IShape bigger than the given IShape?
...
//compute the distance to 0 of the edge of this Circle
public double distToOrigin() {
return this.center.distToOrigin() - this.radius;
}
//is this Circle bigger than the given IShape?
public boolean biggerThan(IShape that) {
/* fields of that: none
 * methods of that: 
 *  that.area()
 *  that.distToOrigin()
 *  that.biggerThan(IShape)
 * methods for fields of that: none
 */
...
//compute the distance to 0 of this Square
public double distToOrigin() {
return this.nw.distToOrigin();
}
//is this Square bigger than the given IShape?
public boolean biggerThan(IShape that) {
/* fields of that: none
 * methods of that: 
 *  that.area()
 ...
 */ 
//compute the area of this Combo
public double area() {
return this.top.area() + this.bottom.area();
}
//compute the distance to 0 of this Combo
public double distToOrigin() {
return Math.min(this.top.distToOrigin(), this.bottom.distToOrigin());
}
...
return
t.checkInexact(this.combo1.area(), 314.15 + 900.0, 0.01);
}
...
//need to add tests for distToOrigin for a Combo
/*
    // test the method grow in the class Circle
...
// add tests for biggerThan for a Combo
draw a Shape
   boolean testDraw(Tester t) {
   WorldCanvas c = new WorldCanvas(300, 500);
   WorldImage img1 = this.combo.draw();
